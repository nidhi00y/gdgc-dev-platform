      ...
      <main className="flex flex-col row-start-2 items-center sm:items-start">
        <section className="flex px-[4%] lg:mt-[9%] flex-col md:flex-row justify-between my-[6%] gap-5">
          <div className="flex flex-col justify-center items-center relative md:gap-6 sm:gap-2 lg:gap-8 group">
            ...
            >
              <p className="relative text-white z-[5] translate-1 group-hover:-translate-1 transition-transform duration-300">NITJ</p>
          ...
          <div className="flex flex-col items-center text-center md:items-end md:text-right justify-center w-[90%] mx-auto md:mx-0 md:w-[50%] font-bold gap-[66px]">
            <h1 className={`xl:text-8xl lg:text-7xl text-6xl ${spaceGrotesk.className}`}>
            ...
            <p className={`lg:text-2xl md:text-xl text-lg ${redHatMono.className}`}>
        ...
        <section className="w-full relative h-[133vh] p-[4%] flex flex-col bg-cover" style={{backgroundImage: `url(${purpleGridLarge.src})` }}>
          <div className="absolute w-full h-[33vh] z-0 bg-gradient-to-b from-background to-transparent top-0 left-0">
          </div>
          <div className="w-full flex justify-center items-center relative h-[33vh] z-10">
            <h1 className={`text-center lg:text-8xl md:text-7xl text-6xl font-bold ${spaceGrotesk.className} z-10`}>LEVEL 03</h1>
          </div>
          <div className="relative flex flex-col justify-evenly items-center w-full h-[100vh]">
            <div className="text-6xl relative group flex justify-center items-center text-center md:text-7xl lg:text-8xl font-bold">
              <h1 className="relative z-50 translate-1 group-hover:-translate-1 transition-transform duration-300">Behind the Pixels</h1>
              <h1 className="transition-transform duration-300 absolute text-[#FF0000] z-40 translate-2 group-hover:-translate-2">Behind the Pixels</h1>
              <h1 className="transition-transform duration-300 absolute text-[#28D781] z-30 translate-3 group-hover:-translate-3">Behind the Pixels</h1>
              <h1 className="transition-transform duration-300 absolute text-[#FDD568] z-20 translate-4 group-hover:-translate-4">Behind the Pixels</h1>
              <h1 className="transition-transform duration-300 absolute text-[#69A6FC] z-10 translate-5 group-hover:-translate-5">Behind the Pixels</h1>
            </div>
            <div>
