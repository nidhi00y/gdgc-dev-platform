...
const LeadCard: NextPage<Props> = ({name,domain}) => {
    ...
    "
          >
            <Image src={sparkle} className="absolute -top-[10%] left-0" alt="sparkle" />
            <div style={{backgroundImage: `url(${iconContainer.src})`}} className="flex w-30 h-30 bg-no-repeat bg-contain justify-center items-center absolute -bottom-[10%] right-[5%]">
